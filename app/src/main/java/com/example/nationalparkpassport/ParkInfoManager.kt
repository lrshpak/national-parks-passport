...
class ParkInfoManager
{
    ...
    fun retrieveParks(stateCode:String, successCallback: (List<Park>) -> Unit, errorCallback: (Exception) -> Unit)
    {
        ...
        val request = Request.Builder()
            .url("https://developer.nps.gov/api/v1/parks?stateCode=$parkCode&api_key=IS0ChGgMSmnhwTqvxI71JbzAUZcIHNPba43WYzz2")
            .build()
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                if(response.isSuccessful()&& responseString != null){
                    ...
                    for(i in 0 until parks.length()){
                            ...
                            val weather = curr.getString("weatherInfo")
                            val directions = curr.getString("directionInfo")
